...
class __Mustache_ebcbd3c4047467a64778eff701bab0ab extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section89839d7815aa9f0caaaac4d94608719b($context, $indent, $value);
        $buffer .= $indent . '</div>
';
    ...
    private function section40aed27b3bce636c321215f876937ed0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
    ...
    private function section89839d7815aa9f0caaaac4d94608719b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
                ...
                $buffer .= $this->section40aed27b3bce636c321215f876937ed0($context, $indent, $value);
                $buffer .= '
';
                $buffer .= $indent . '        </div>
';
