...
class __Mustache_57c1f8f843881c1471c33662a880924d extends Mustache_Template
{
...
';
        ...
        $blocksContext['eventlistitems'] = array($this, 'blockC41302f9ec5950c2e306bb60aab730de');
...
';
        ...
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '" class="btn btn-secondary text-primary"
';
        $buffer .= $indent . '           aria-label="';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section0d8752a37fd1c10c2e89d8e696eb5847($context, $indent, $value);
        $buffer .= '">
';
        $buffer .= $indent . '            ';
        // 'str' section
...
';
    ...
    private function section0d8752a37fd1c10c2e89d8e696eb5847(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
