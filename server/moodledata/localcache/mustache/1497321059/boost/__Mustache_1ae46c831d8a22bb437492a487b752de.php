...
class __Mustache_1ae46c831d8a22bb437492a487b752de extends Mustache_Template
{
    ...
    ';
        ...
        $blocksContext['progresstext'] = array($this, 'block09abc823a3c4e05bd90c7593d449d02c');
        $blocksContext['percentage'] = array($this, 'block34ecb99b6aae2767331b27e354e30d39');
        $blocksContext['percentlabel'] = array($this, 'block7d7b29e4af28232b5b00b862f84c2135');
