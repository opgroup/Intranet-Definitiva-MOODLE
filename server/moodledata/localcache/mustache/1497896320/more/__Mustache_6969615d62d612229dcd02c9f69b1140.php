...
class __Mustache_6969615d62d612229dcd02c9f69b1140 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6789dd4bf5a00a1c29962f44c8c24bbe($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section14e0ed68f1b5f58172e730d9f2a1ec4c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
    ...
    private function section492feef18605478c72148a77b62e27aa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
                ...
                $buffer .= $this->section14e0ed68f1b5f58172e730d9f2a1ec4c($context, $indent, $value);
                $buffer .= $indent . '                            ';
                $value = $this->resolveValue($context->find('name'), $context);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '
...
';
    ...
    private function section6789dd4bf5a00a1c29962f44c8c24bbe(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
                ...
                $buffer .= $this->section492feef18605478c72148a77b62e27aa($context, $indent, $value);
                $buffer .= $indent . '            </div>
';
                $buffer .= $indent . '        </div>
';
