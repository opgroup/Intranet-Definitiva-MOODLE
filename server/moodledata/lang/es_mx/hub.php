...
/**
 * Strings for component 'hub', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   hub
...
$string['mobilenotificacionsenabled'] = 'Notificaciones Mobile habilitadas ({$a})';
...
$string['registeredactiveuserdevices'] = 'Número de dispositivos Mobile registrados de usuario activos ({$a})';
...
$string['registereduserdevices'] = 'Número de dispositivos Mobile registrados de usuario ({$a})';
...
$string['registrationconfirmedon'] = 'Gracias por registrar su sitio. La información del registro se mantendrá actualizada por el quehacer  agendado del sistema \'Registro del sitio\'.';
...
$string['tags_help'] = 'Las marcas (tags) ayudan a clasificar mejor su curso y ayudan a encontrarlo. Por favor, use palabras sencillas y significativas separadas por una coma. Ejemplo: matemáticas, álgebra, geometría';
