...
/**
 * Strings for component 'moodle', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   moodle
...
$string['courseduration_desc'] = 'La duración del curso es usada para calcular la fecha por defecto de terminación del curso. La fecha de terminación del curso solamente es usada para reportes. Los usuarios todavía pueden ingresar al curso después de la fecha de terminación.';
...
$string['emailpasswordconfirmnoemail'] = '<p>La cuenta de usuario que Usted especificó no tiene grabada una dirección de Email.</p> <p>Por favor, contacte al administrador.</p>';
$string['emailpasswordconfirmnotsent'] = '<p>El detalle del usuario que Usted proporcionó no identifica una cuenta de usuario existente.</p> <p>Por favor, revise la información que escribió, y vuelva a intentarlo. Si continúa teniendo dificultades, por favor contacte al administrador del sitio.</p>';
...
Si necesita ayuda, por favor contacte al administrador del sitio, {$a->admin}';
$string['emailresetconfirmationsubject'] = '{$a}: Solicitud de reinicio de contraseña';
$string['emailresetconfirmsent'] = 'Se ha enviado un Email a su dirección en <b>{$a}</b>. <br />Este Email contiene instrucciones sencillas para confirmar y completar este cambio de contraseña. Si Usted continúa experimentando dificultades, contacte al administrador del sitio.';
...
$string['enddate_help'] = 'La fecha de terminación del curso solamente se usa para reportes. Los usuarios todavía pueden ingresar al curso después de la fecha de terminación.';
...
$string['eventsearchindexed'] = 'Datos de búsqueda indexados (indizados)';
...
$string['filetoolarge'] = 'es demasiado grande para subirlo';
...
$string['interestslist_help'] = 'Escriba sus intereses, uno a uno, separados por comas, los cuales se mostrarán en la página de su perfil como marcas (tags) ... Evite escribir palabras soeces y términos políticamente incorrectos.';
...
$string['legacylogginginuse'] = 'Éste sitio actualmente tiene habilitado el escribir al almacén de bitácoras antiguo. El escribir hacia éste almacen de bitácoras está deprecado. Por favor, escriba hacia un almacenamiento de bitácoras soportado, como por ejemplo "estándar" o "externo".';
...
$string['maxareabytesreached'] = 'El archivo (o el tamaño total de varios archivos) es más grande que el espacio restante en ésta área.';
...
$string['resetrecordexpired'] = 'El enlace para reiniciar contraseña que Usted usó tiene más de {$a} minutos de antigüedad y ha caducado. Por favor, inicie un nuevo reinicio de contraseña.';
$string['resetstartdate'] = 'Reajustar fecha inicial';
$string['resetstatus'] = 'Estatus';
$string['resettable'] = 'Reiniciar  preferencias de tabla';
$string['resettask'] = 'Quehacer';
...
$string['rsskeyshelp'] = '<p>Para garantizar la seguridad y la privacidad, las direcciones URL RSS feed contienen una ficha (token) especial que identifica al usuario para el que son. Esto impide que otros usuarios accedan a áreas de Moodle a las que no deben tener acceso. </p><p> Esta ficha se crea automáticamente la primera vez que accede a un área de Moodle, que produce una fuente RSS. Si usted piensa que su ficha de fuente RSS ha sido comprometido de alguna manera, Usted puede solicitar una nueva haciendo clic en el vínculo para Restablecer enlace. Tenga en cuenta que la URL de su fuente RSS actual dejará de ser válida.';
...
$string['signoutofotherservices'] = 'Sacar a todos';
$string['signoutofotherservices_help'] = 'Si se activa, la cuenta será dacada de todos los dispositivos y sistemas que usan servicio web, como la App mobile.';
$string['since'] = 'Desde';
...
Por favor, tome nota de que esta vista podría no ser perfecta  (<a href="https://docs.moodle.org/all/es/Capabilities/moodle/role:switchroles">Vea los detalles y alternativas</a>).';
$string['tag'] = 'Marca';
$string['tagalready'] = 'Esta marca ya existe';
$string['tagmanagement'] = 'Agregar/Eliminar marcas (tags) ...';
...
$string['toomanytags'] = 'Esta búsqueda incluye demasiadas marcas (tags); algunas serán ignoradas.';
