...
/**
 * Strings for component 'data', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   data
...
$string['availabletags'] = 'Marcas (tags) disponibles';
$string['availabletags_help'] = 'Las marcas (\'tags\') son remplazables (\'placeholders\') en la plantilla que se sustituirán con datos o con otras características (como un ícono de edición) cuando se editan o se muestran las entradas.
...
$string['calendarend'] = 'Base de datos {$a} cierra';
$string['calendarstart'] = 'Base de datos {$a} abre';
...
$string['cannotoverwritepreset'] = 'Error al sobre-escribir preconfiguración';
...
$string['fromfile_help'] = 'Importar un archivo zip permite buscar y subir una preconfiguración de plantillas y campos.';
...
$string['multipletags'] = 'Se han encontrado múltiples marcas (tags). Plantilla no guardada';
...
$string['presetinfo'] = 'Al guardar una preconfiguración previo se publicará esta plantilla. Otros usuarios podrán usarla en sus bases de datos.';
...
$string['requiredentries_help'] = 'Si se configura, se muestra un mensaje diciendo el número de entradas necesarias para finalización. Tome nota de que esta configuración no está conectda con finalización de la actividad.
...
$string['saveaspreset_help'] = 'La opción Guardar como característica preconfigurada publica las plantillas y los campos como una preconfiguración que otros usuarios del sitio pueden utilizar. (Puede borrarla de la lista de preconfiguraciones en cualquier momento.)';
