...
/**
 * Strings for component 'taskchain', language 'es_mx', branch 'MOODLE_33_STABLE'
 *
 * @package   taskchain
...
$string['completedalltasks_close'] = 'Si Usted quiere terminar y cerrar este intento, haga click en el botón inferior.<br />Tome nota de que Usted no podrá re-hacer quehaceres en este intento después de que haya sido cerrado.';
$string['completedalltasks_redo'] = 'Si Usted quiere re-hacer uno de los quehaceres en esta actividad, haga click en el nombre del quehacer en la lista inferior.';
$string['completedalltasks_title'] = '¡Felicitaciones!<br />Usted ha completado todos los quehaceres en esta actividad.';
