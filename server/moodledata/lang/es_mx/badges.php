...
/**
 * Strings for component 'badges', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   badges
...
$string['attachment_help'] = 'Si se activa, una insignia otorgada se anexará al Email del recipiente para que sea descargada. (Deben habilitarse los anexos a Email en Administración del sitio > Plugins > Salida de mensajes > Email usar esta opción.)';
...
$string['backpackconnectionunexpectedresult'] = 'Hubo un problema al contactar a la Mochila. Por favor, inténtelo nuevamente.<br><br>Si este problema persiste, por favor contacte a su administrador.';
...
Para confirmarlo y activar la conexión a su mochila, por favor haga click en el enlace inferior.
...
$string['backpackemailverifypending'] = 'Se ha enviado un Email de notificación a <strong>{$a}</strong>. Haga click en el enlace para verificación en el Email para activar su conexión a Mochila.';
$string['backpackemailverifysuccess'] = 'Gracias por verificar su dirección Email. Usted está ahora conectado a su Mochila.';
$string['backpackemailverifytokenmismatch'] = 'La ficha (token) en el enlace al que Usted hizo click no coincide con la ficha (token) almacenada. Asegúrese de que Usted hizo click en el Email más reciente que Usted recibió.';
