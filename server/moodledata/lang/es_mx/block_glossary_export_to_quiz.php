...
/**
 * Strings for component 'block_glossary_export_to_quiz', language 'es_mx', branch 'MOODLE_27_STABLE'
 *
...
$string['notenoughentriesavailable'] = 'No hay suficientes entradas disponibles ({$a}) para preguntas de Opción Múltiple (se necesitan 4 entradas mínimo).';
$string['notenoughentriesselected'] = 'No hay suficientes entradas seleccionadas ({$a}) para preguntas de Opción Múltiple (se necesitan 4 entradas mínimo).';
