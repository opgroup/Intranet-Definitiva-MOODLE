...
/**
 * Strings for component 'error', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   error
...
$string['cannoteditcommentexpired'] = 'Usted no puede editar esto. El tiempo ha caducado!';
...
$string['cannotreprocessgrades'] = 'No se pudo re-procesar calificaciones para ésta actividad {$a}';
...
$string['expiredkey'] = 'Clave caduca';
...
$string['privatefilesupload'] = 'Ya no está soportado el subir directamente hacia el área de archivos privados del usuario. Suba a un área de borrador y después mueva los archivos con core_user::add_user_private_files';
...
$string['sitepolicynotagreed'] = 'No ha aceptado la política del sitio: <a href="{$a}">Haga click aquí para abrir la política del sitio.</a>';
...
$string['tagdisabled'] = 'Las marcas (tags) están deshabilitadas';
