...
/**
 * Strings for component 'block_cmanager', language 'es_mx', branch 'MOODLE_29_STABLE'
 *
...
$string['cannotapproverecord'] = 'Lo sentimos, Usted no puede aprobar registros';
$string['cannotcomment'] = 'Lo sentimos, Usted no puede comentar';
$string['cannotdelete'] = 'Lo sentimos, Usted no puede eliminar un registro';
$string['cannoteditrequest'] = 'Lo sentimos, Usted no puede editar un registro';
$string['cannotrequestcourse'] = 'Lo sentimos, Usted no puede solicitar un curso';
$string['cannotviewconfig'] = 'Lo sentimos, Usted no puede ver la configuración';
$string['cannotviewrecords'] = 'Lo sentimos, Usted no puede ver registros';
