...
/**
 * Strings for component 'socialwiki', language 'es_mx', branch 'MOODLE_32_STABLE'
 *
 * @package   socialwiki
...
$string['cannotviewpage'] = 'Uste dno puede ver esta página.';
...
$string['mylikes_empty'] = 'Usted no tiene ningun like';
...
$string['removeallwikitags'] = 'Quitar todas las marcas (tags) de wiki';
...
$string['tagsdeleted'] = 'Se han eliminado marcas (tags) de wiki';
$string['tagtitle'] = 'Se necesita la marca (tag)  "{$a}"';
