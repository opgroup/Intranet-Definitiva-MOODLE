...
$string['showadvancedbodytags'] = 'Mostrar información avanzada de marca (tag) de cuerpo';
$string['showadvancedbodytagsdesc'] = 'Al elegir esta casilla mostrará absolutamente todas las clases que están aplicadas a la marca (tag) del cuerpo, en lugar del conjunto simplificado que Usted ve por defecto.';
