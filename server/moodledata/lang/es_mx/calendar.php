...
/**
 * Strings for component 'calendar', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   calendar
...
$string['detailedmonthviewfor'] = 'Vista detallada del mes para:';
...
$string['erroraddingevent'] = 'No pudo añadir evento';
$string['errorbadsubscription'] = 'No se encontró subscripción a calendario';
$string['errorbeforecoursestart'] = 'No puede programar un evento antes de la fecha de comienzo del curso';
$string['errorcannotimport'] = 'Usted no puede configurar una subscripción a calendario actualmente.';
$string['errorhasuntilandcount'] = 'Ya sea UNTIL (hasta) o COUNT (número) pueden aparecer en una regla de recurrencia, pero UNTIL y COUNT juntos NO DEBEN de ocurrir en la misma regla de recurrencia.';
$string['errorinvalidbydayprefix'] = 'Valores de números enteros, precediendo reglas de BYDAY solamente pueden estar presentes para MONTHLY o YEARLY rule.';
...
$string['errorrrule'] = 'la rrule pasada parece incorrecta';
$string['errorrruleday'] = 'La rrule tiene un parámetro de día inválido';
$string['errorrrulefreq'] = 'La rrule tiene un parámetro de frecuencia inválido';
...
$string['eventsubscriptioneditwarning'] = 'El evento del calendario es parte de una suscripción. Cualquier cambio que Usted le haga a este evento se perderá si se elimina la suscripción.';
...
$string['pollinterval_help'] = 'Qué tan frecuentemente le gustaría que se actualizara el calendario con nuevos eventos.';
