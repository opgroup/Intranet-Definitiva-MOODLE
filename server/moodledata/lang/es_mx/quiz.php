...
/**
 * Strings for component 'quiz', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   quiz
...
$string['completionpass_help'] = 'Si se habilita, esta actividad es considerada completa cuando el estudiante recibe ua calificación aprobatoria, que está puesta en el libro de calificaciones';
...
$string['gradetopassnotset'] = 'Este examen no tiene configurada una calificación aprobatoria, por lo que Usted no puede usar esta opción. Por favor, use en cambio la configuración de requerir calificación.';
...
$string['questiondependencyadd'] = 'No hay restricción acerca de cuando la pregunta {$a->thisq} pueda ser intentada • Haga click para cambiar';
$string['questiondependencyfree'] = 'Sin restricción en esta pregunta';
$string['questiondependencyremove'] = 'La pregunta {$a->thisq} no puede ser intentada hasta que la pregunta anterior {$a->previousq} haya sido completada • Haga click para cambiar';
...
$string['redoquestion'] = 'Intentar otra pregunta similar a ésta';
...
**Immediatamente después del intento** estas configuraciones aplican para los primeros dos minutos después de hacer click en \'Enviar todo y terminar\'.
