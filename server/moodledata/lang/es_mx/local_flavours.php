...
/**
 * Strings for component 'local_flavours', language 'es_mx', branch 'MOODLE_30_STABLE'
 *
...
$string['defaultsoverwrite'] = 'Sobre-escribir local/defaults.php';
...
$string['generatedefaultsinfo'] = 'Seleccionar cual de las configuraciones actuales sobre-escribirá los valores por defecto del sistema';
...
$string['settingswarning'] = 'Por favor, tome nota de que el ingrediente de \'Configuraciones (Settings)\' no es confiable y puede conducir a resultados inesperados. Considere usar <a href="https://moodle.org/plugins/block_admin_presets" target="_blank">https://moodle.org/plugins/block_admin_presets</a> para importar/exportar configuraciones del sitio.';
