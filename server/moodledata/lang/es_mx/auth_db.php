...
/**
 * Strings for component 'auth_db', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbpasstype'] = '<p>Especifique el formato que usa el campo de contraseña. La encriptación MD5 es útil para conectar con otras aplicaciones web como PostNuke.</p> <p>Use "interno" si quiere que la base de datos externa gestione los nombres_de_usuarios y las direcciones de correo electrónico, pero que Moodle administre las contraseñas. Si utiliza "interno", Usted <i>debe de</i> proporcionar un campo con una  dirección de correo electrónico utilizada en la base de datos externa, y Usted debe ejecutar regularmente tanto admin/cron.php como auth/db/cli/sync_users.php. Moodle enviará un correo electrónico a los nuevos usuarios con una contraseña temporal.</p>';
...
$string['auth_dbsyncuserstask'] = 'Sincronizar quehaceres de usuarios';
