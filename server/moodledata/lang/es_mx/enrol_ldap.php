...
/**
 * Strings for component 'enrol_ldap', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   enrol_ldap
...
$string['autoupdate_settings'] = 'Configuraciones para actualización de curso automática';
$string['autoupdate_settings_desc'] = '<p>Seleccione campos a actualizar cuando corra el script de sincronización (enrol/ldap/cli/sync.php).</p><p>Cuando esté seleccionado al menos un campo, ocurrirá una actualización.</p>';
...
$string['syncenrolmentstask'] = 'Quehacer de sincronizar inscripciones';
