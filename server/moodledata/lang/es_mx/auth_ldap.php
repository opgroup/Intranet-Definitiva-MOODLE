...
/**
 * Strings for component 'auth_ldap', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   auth_ldap
...
$string['updatepasserrorexpire'] = 'Error en user_update_password{} al leer el período de caducidad de la contraseña.  Código de error: {$a->errno}. Cadena del error: {$a->errstring}';
