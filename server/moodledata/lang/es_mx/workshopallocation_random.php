...
/**
 * Strings for component 'workshopallocation_random', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
...
$string['allocationdeallocategraded'] = 'No es posible des-asignar valoración ya calificada: revisor <strong>{$a->reviewername}</strong>, autor del envío: <strong>{$a->authorname}</strong>';
