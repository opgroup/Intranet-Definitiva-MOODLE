...
/**
 * Strings for component 'cache', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   cache
...
$string['cachedef_capabilities'] = 'Lista de capacidades del sistema';
$string['cachedef_completion'] = 'Estatus de finalización de actividad';
...
$string['cachedef_coursemodinfo'] = 'Información acumulada acerca de módulos y secciones para cada curso';
...
$string['cachedef_message_processors_enabled'] = 'Estatus habilitadod e procesadores de mensaje';
$string['cachedef_message_time_last_message_between_users'] = 'Hora de creación para mensajes más recientes entre usuarios';
$string['cachedef_navigation_expandcourse'] = 'Cursos con navegación expadible';
$string['cachedef_observers'] = 'Observadores del evento';
$string['cachedef_plugin_functions'] = '\'Callbacks\' de plugins disponibles';
$string['cachedef_plugin_manager'] = 'Gestor de información de plugin';
...
$string['cachedef_tagindexbuilder'] = 'Buscar resultados para ítems marcados (tags)';
$string['cachedef_tags'] = 'Marcar (tag) colecciones y áreas';
$string['cachedef_temp_tables'] = 'Caché de tablas temporales';
$string['cachedef_userselections'] = 'Datos usados para persistencia de selecciones de usuarios en Moodle';
...
$string['localstorenotification'] = 'Éste caché puede ser mapeado con seguridad hacia un almacén que sea local para cada webserver';
$string['lockdefault'] = 'Por defecto';
$string['locking'] = 'Bloqueando';
$string['locking_help'] = 'El bloqueo (locking) es un mecanismo que restringe el acceso a los datos cacheados a un proceso a la vez, para impedir que los datos se sobre-escriban. El método de bloqueo determina como se adquiere el bloqueo y como se revisa.';
...
$string['sharedstorenotification'] = 'Éste caché puede ser mapeado hacia un almacén que esté compartido por todos los webservers';
