...
/**
 * Strings for component 'feedback', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   feedback
...
$string['bold'] = 'Negrita';
$string['calendarend'] = 'Retroalimentación {$a} cierra';
$string['calendarstart'] = 'Retroalimentación {$a} abre';
...
$string['relateditemsdeleted'] = 'Se eliminarán también todas las respuestas para esta pregunta.';
