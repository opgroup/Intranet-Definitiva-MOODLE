...
/**
 * Strings for component 'local_boostcoc', language 'es_mx', branch 'MOODLE_32_STABLE'
 *
...
$string['setting_changefilterslinktarget_desc'] = 'Con esta configuración, Usted controla el destino del enlace a cambiar filtros. Usted puede configurarlo a la página inicial del curso o al Tablero del usuario. Esto coincide con las dos localizaciones en dond epuede colocarse  block_course_overview_campus.<br />Por favor tome nota: Para evitar confusión, por favor asegúrese de que block_course_overview_campus siempre esté situado en la página destino al ponerla allí como un bloque pegajoso.<br /><em>Esta configuración siempre es procesada cuando está activado "Añadir enlace a cambiar filtros".</em>';
