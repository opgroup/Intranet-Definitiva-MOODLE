...
/**
 * Strings for component 'block_course_overview_campus', language 'es_mx', branch 'MOODLE_32_STABLE'
 *
...
$string['nocourses'] = 'Actualmente, Usted no está inscrito en ningun curso';
$string['noteacher'] = 'Sin maestros inscritos';
$string['noteachertext'] = 'Texto cuando no hay maestros inscritos';
