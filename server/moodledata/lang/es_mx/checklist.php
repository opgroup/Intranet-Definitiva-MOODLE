...
/**
 * Strings for component 'checklist', language 'es_mx', branch 'MOODLE_33_STABLE'
 *
 * @package   checklist
...
Si está activado el rastreo de la finalización para una actividad en particular, ésta se usará para tachar al ítem de la lista<br>
...
$string['modulename_help'] = 'El módulo de Lista de Cotejo (checklist) le permite al maestro crear una lista de cotejo / lista de quehaceres / lista de pendientes, para que sus estudiantes trabajen al respecto.';
