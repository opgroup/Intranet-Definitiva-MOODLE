...
/**
 * Strings for component 'workshopallocation_scheduled', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
...
Internamente, el método aleatorio para asignación se ejecuta con los parámetros pre-definidos en este formato. Esto significa que la asignación agendada funciona como si el maestro eejecutase por si mismo la asignacón aleatoria al final de la fase de envíos, empleando las configuraciones de asignación descritas debajo.
